<?php
	# estara disponivel no contexto de tarefa_controller requisitado
	$acao = 'recuperar';
	# importando  tarefa_controller que por sua vez faz um require_once tarefa_controller
					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								...
								<!--
									# @param1 objeto recebido de tarefa_controler
									# @param2 indice
									# @param3 Obeto tarefa
								-->
